        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layout" class="form-horizontal">
          ...
          <fieldset>
              <legend><?php echo $text_module; ?>&emsp;
                  <a target="_blank" data-toggle="tooltip" title="" data-original-title="<?php echo $hp_name_titles; ?>" class="btn btn-danger" href="https://opencartforum.com/files/file/3588-hyper-positions-71-modulnaya-poziciya-24-bloka/" role="button">
            ...
            <div class="row hyper-positions">
              ...
              <div class="col-sm-12 pos-content">
                <div class="row">
                  <div class="text-center col-sm-12"><div class="col-sm-12 positions-name"><?php echo $text_content_pos; ?></div></div>
              ...
              <div class="col-sm-12 pos-map">
                <div class="row">
                  <div class="text-center col-sm-12"><div class="col-sm-12 positions-name"><?php echo $text_map_pos; ?></div></div>
                  <div class="col-sm-12">
